...
| Tie Event                   | In the event of a tie, the player who had the furthest run will be declared the winner. Full clear bonus points ARE NOT milestones. If players are still tied, a 1-seed sudden death play-off will be completed to determine the winner. Points will NO LONGER MATTER and the first player to complete the Rival 1 battle sets the distance to beat. (E.g. Player 1 finally beats Rival 1 on sudden death seed 3 and dies at Falkner. Player 2 dies to Rival 1 three times. Player 1 is declared the winner.) |
